...
class UserService(BaseService):
    ...
    @tracer.start_as_current_span('get-all-users')
    def all(self) -> schema:
    ...
    @tracer.start_as_current_span('update-user')
    ...
    @tracer.start_as_current_span('set-user-role')
    ...
    @tracer.start_as_current_span('retrieve-user-role')
