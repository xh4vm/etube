...
from ..services.user_social import UserSocialService
...
class OAuthContainer(BaseContainer):
    ...
    user_social_service = providers.Factory(UserSocialService, storage_svc=BaseContainer.storage_svc)
    auth_service = AuthFactory(BaseOAuth)
